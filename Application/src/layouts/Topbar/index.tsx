...
import logo from '@/assets/images/macmillan-logo.svg';
import logoDark from '@/assets/images/macmillan-logo-dark.svg';
import logoSm from '@/assets/images/macmillan-logo-sm.svg';
import logoDarkSm from '@/assets/images/macmillan-logo-dark-sm.svg';
            ...
            <div className="topbar container-fluid">
                ...
                <ul className="topbar-menu d-flex align-items-center gap-3">
                    ...
                    {/* <li className="dropdown">
                        <ProfileDropdown userImage={userImage} menuItems={profileMenus} username={'Dominic Keller'}
                                         userTitle={'Founder'}/>
                    </li> */}
                </ul>
            </div>
